...
/**
 * Dans cette classe, nous implémentons la génération aléatoire de la main du joueur et la fonction déplacer.
 */
        ...
        do             //blindage exception pour le choix du menu bateau
        {
            do {
                try {
                    ...
                    System.out.println("L'entrée doit être un chiffre compris entre 0 et 9.");
                    x = 1;
                }
            } while (x != 0);
                ...
                do             //blindage exception pour le choix du menu bateau
                {
                    do {
                        try {
                            ...
                            System.out.println("L'entrée doit être un chiffre compris entre 0 et 1.");
                            x = 1;
                        }
                    } while (x != 0);
            ...
            do             //blindage exception pour le choix du menu bateau
            {
                do {
                    try {
                        ...
                        System.out.println("L'entrée doit être un chiffre compris entre 0, 1,2 et 3.");
                        x = 1;
                    }
                } while (x != 0);
            } while ((reponse != 1) && (reponse != 0) && (reponse != 2) && (reponse != 3));
